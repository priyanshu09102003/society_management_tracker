    ...
    <AuthHero fullScreen>
      <div className="min-h-screen w-full flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-[400px] rounded-[24px] border border-white/15 bg-white/10 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.37)] p-8 flex flex-col gap-8">
          <div className="text-[18px] font-bold text-white tracking-[-0.3px]">
            Society Tracker
          </div>

          <div className="flex flex-col gap-3">
            <h1 className="text-[28px] font-bold text-[#eee] leading-[1.3] tracking-[-0.5px]">
              Sign in to your Account
            </h1>
            <div className="flex gap-1.5 items-center text-[12px] tracking-[-0.12px]">
              <span className="text-white/80 font-medium">Don&apos;t have an account?</span>
              <a href="/register" className="text-[#7DA3F5] font-semibold underline">
                Sign Up
              </a>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center justify-between w-full">
                <label className="flex items-center gap-[5px] text-[12px] font-medium text-white/70 tracking-[-0.12px]">
                  <input type="checkbox" className="size-[16px] accent-[#375DFB]" />
                  Remember me
                </label>
                <a href="#" className="text-[12px] font-semibold text-[#7DA3F5] tracking-[-0.12px]">
                  Forgot Password ?
                </a>
              </div>
            </div>

            {error && <p className="text-[13px] text-red-300 -mt-2">{error}</p>}
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-4">
                <div className="flex items-center gap-4 w-full">
                  ...
                  <span className="text-[12px] text-white/50 tracking-[-0.12px]">Or login with</span>
                  <div className="flex-1 h-px bg-white/15" />
                </div>
          ...
          <p className="text-center text-[11px] text-white/50 leading-[1.5]">
            By signing up, you agree to the{" "}
            <span className="font-semibold text-white/80">Terms of Service</span> and{" "}
            <span className="font-semibold text-white/80">Data Processing Agreement</span>
          </p>
        </div>
      </div>
    </AuthHero>
